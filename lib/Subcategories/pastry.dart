...
class PastrySubCategory extends StatefulWidget {
  final String cakeName;
  PastrySubCategory(this.cakeName);

  @override
  _PastrySubCategoryState createState() => _PastrySubCategoryState();
}

class _PastrySubCategoryState extends State<PastrySubCategory> {
  List categories = [];
  bool isLoading = true;
  ...
  void loadData() async {
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        .collection(
            "/category/bZ82LjA8Ca2iNScm7wQb/Pastry/${widget.cakeName}/Products")
        .get();
