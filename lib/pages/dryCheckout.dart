...
class DryCheckoutPage extends StatefulWidget {
  @override
  _DryCheckoutPageState createState() => _DryCheckoutPageState();
}

class _DryCheckoutPageState extends State<DryCheckoutPage> {
  Razorpay _razorpay;
  ...
  Widget _buildCODButton(BuildContext context) {
    ...
    String on = DateFormat('kkmmssd').format(now);
    String ordernumber = 'RE' + on.toString();
          ...
          onTap: () {
            ...
            Firestore.instance
              ...
              Firestore.instance
                  .collection("/Order Number")
                  .doc("order number")
                  .set({"order number": ordernumber}).then((value) {
                print("====================================");
                FirebaseFirestore.instance.collection("DryOrders").doc().set({
